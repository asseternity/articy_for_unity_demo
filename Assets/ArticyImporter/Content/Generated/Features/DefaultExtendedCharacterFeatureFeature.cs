...
namespace Articy.Articy_Tutorial.Features
{
    ...
    public class DefaultExtendedCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Articy_Tutorial.Features.DefaultExtendedCharacterFeatureFeature newClone = ((Articy.Articy_Tutorial.Features.DefaultExtendedCharacterFeatureFeature)(aClone));
            if ((mMotivation != null))
            {
        ...
        {
            Articy.Articy_Tutorial.Features.DefaultExtendedCharacterFeatureFeature clone = new Articy.Articy_Tutorial.Features.DefaultExtendedCharacterFeatureFeature();
