...
namespace Articy.Articy_Tutorial.Features
{
    ...
    public class DefaultBasicCharacterFeatureFeature : IArticyBaseObject, IPropertyProvider
    {
        ...
        {
            Articy.Articy_Tutorial.Features.DefaultBasicCharacterFeatureFeature newClone = ((Articy.Articy_Tutorial.Features.DefaultBasicCharacterFeatureFeature)(aClone));
            newClone.Age = Age;
            if ((mSpecies != null))
            {
        ...
        {
            Articy.Articy_Tutorial.Features.DefaultBasicCharacterFeatureFeature clone = new Articy.Articy_Tutorial.Features.DefaultBasicCharacterFeatureFeature();
