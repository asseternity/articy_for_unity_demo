...
namespace Articy.Articy_Tutorial
{
    ...
    public class DefaultSupportingCharacterTemplate : Entity, IEntity, IPropertyProvider, IObjectWithFeatureDefaultBasicCharacterFeature
    {
        ...
        private static Articy.Articy_Tutorial.Templates.DefaultSupportingCharacterTemplateTemplateConstraint mConstraints = new Articy.Articy_Tutorial.Templates.DefaultSupportingCharacterTemplateTemplateConstraint();
        
        public Articy.Articy_Tutorial.Templates.DefaultSupportingCharacterTemplateTemplate Template
        {
            get
            {
        ...
        public static Articy.Articy_Tutorial.Templates.DefaultSupportingCharacterTemplateTemplateConstraint Constraints
        {
            get
            {
                return mConstraints;
        ...
        protected override void CloneProperties(object aClone, Articy.Unity.ArticyObject aFirstClassParent)
        {
            ...
            if ((Template != null))
            {
                newClone.Template = ((Articy.Articy_Tutorial.Templates.DefaultSupportingCharacterTemplateTemplate)(Template.CloneObject(newClone, aFirstClassParent)));
            }
